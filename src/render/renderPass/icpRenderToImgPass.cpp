...
//
//void icpRenderToImgPass::initializeRenderPass(RendePassInitInfo initInfo)
//{
//	m_rhi = initInfo.rhi;
//
//	createViewPortImage();
...
//
//
//void icpRenderToImgPass::createViewPortImage()
//{
//	m_rhi->m_viewPortImages.resize(m_rhi->m_swapChainImages.size());
//	m_rhi->m_viewPortImageDeviceMemory.resize(m_rhi->m_swapChainImages.size());
//
...
//		// Create the image
//		// VkImage dstImage;
//		vkCreateImage(m_rhi->m_device, &imageCreateCI, nullptr, &m_rhi->m_viewPortImages[i]);
//		// Create memory to back up the image
//		VkMemoryRequirements memRequirements;
//		VkMemoryAllocateInfo memAllocInfo{};
//		memAllocInfo.sType = VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO;
//		// VkDeviceMemory dstImageMemory;
//		vkGetImageMemoryRequirements(m_rhi->m_device, m_rhi->m_viewPortImages[i], &memRequirements);
...
//		vkAllocateMemory(m_rhi->m_device, &memAllocInfo, nullptr, &m_rhi->m_viewPortImageDeviceMemory[i]);
//		vkBindImageMemory(m_rhi->m_device, m_rhi->m_viewPortImages[i], m_rhi->m_viewPortImageDeviceMemory[i], 0);
//
...
//		imageMemoryBarrier.image = m_rhi->m_viewPortImages[i];
...
//	}
//
//	m_rhi->m_viewPortImageViews.resize(m_rhi->m_viewPortImages.size());
//
//	for (uint32_t i = 0; i < m_rhi->m_viewPortImages.size(); i++)
//	{
//		m_rhi->m_viewPortImageViews[i] = icpVulkanUtility::createImageView(m_rhi->m_viewPortImages[i], VK_FORMAT_B8G8R8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, 1, m_rhi->m_device);
//	}
//}
//
//
//void icpRenderToImgPass::createRenderPass()
//{
...
//}
//
//void icpRenderToImgPass::setupPipeline()
//{
...
//}
//
//void icpRenderToImgPass::createFrameBuffers()
//{
//	m_viewPortFramebuffers.resize(m_rhi->m_viewPortImageViews.size());
//
//	for (size_t i = 0; i < m_rhi->m_viewPortImageViews.size(); i++)
//	{
//		std::array<VkImageView, 1> attachments = { m_rhi->m_viewPortImageViews[i] };
//
...
//}
//
//void icpRenderToImgPass::render(uint32_t frameBufferIndex, uint32_t currentFrame, VkResult acquireImageResult, VkSubmitInfo& info)
//{
